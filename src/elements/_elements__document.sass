...
$e-document__body--color: color-transform($f-color__neutral-primary, "ultra-dark") !default
$e-document__body--bgcolor: color-transform($f-color__neutral-primary-bg, "ultra-light") !default
